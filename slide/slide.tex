...
\begin{frame}{Introduction - Technics}
    \begin{itemize}
        ...
        \item Other Special Effects: Depth of Field, Chromatic Dispersion
    \end{itemize}
\end{frame}
...
\subsection{Rendering with Relativity effect}
\begin{frame}{Results - Relativity Effect}
    We have implemented a basic version of relativistic rendering, which simulates the visual effects of objects moving at speeds close to the speed of light. This includes phenomena such as length contraction and Doppler shifting of colors. In this figure, the cubes appear distorted due to their high velocity relative to the observer.
\end{frame}
\begin{frame}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{fig/0.png}
...
\begin{frame}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{fig/9.png}
